(function() {
  ...
  this.$expand_action_macros = (function(_this) {
    return function(S) {
      ...
      /* TAINT code duplication */
      return $(function(event, send) {
        var content, entry, i, id, is_do, language, len, meta, mode, name, ref, ref1, results, stretch, text, type;
        if (MKTS.select(event, '.', 'text')) {
          is_do = true;
          type = event[0], name = event[1], text = event[2], meta = event[3];
  ...
  this.$expand_command_and_value_macros = (function(_this) {
    return function(S) {
      ...
      /* TAINT code duplication */
      return $(function(event, send) {
        var entry, i, id, is_command, len, markup, meta, name, raw, ref, results, stretch, text, type;
        if (MKTS.select(event, '.', 'text')) {
          is_command = true;
          type = event[0], name = event[1], text = event[2], meta = event[3];
