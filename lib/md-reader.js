...
(function() {
  //###########################################################################################################
  var $, CND, D, HELPERS, MKNCR, MKTS, Markdown_parser, alert, assign, badge, debug, echo, get_parse_html_methods, help, info, log, misfit, new_md_inline_plugin, njs_fs, njs_path, parse_methods, rpr, tracker_pattern, urge, warn, whisper,
    indexOf = [].indexOf;
