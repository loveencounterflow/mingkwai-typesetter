...
(function() {
  //###########################################################################################################
  var $, CND, D, HELPERS, MKTS, Markdown_parser, alert, assign, badge, debug, echo, get_parse_html_methods, help, info, log, misfit, new_md_inline_plugin, njs_fs, njs_path, parse_methods, rpr, tracker_pattern, urge, warn, whisper,
    indexOf = [].indexOf;
  ...
  get_parse_html_methods = function() {
    var PARSE5, R, _cast_attribute_value, _resolve_html_attributes, get_message;
    ...
    R = {};
    //.........................................................................................................
    _cast_attribute_value = function(x) {
      if (x === '') {
        return true;
      } else {
        return x;
    ...
    _resolve_html_attributes = function(facets) {
      ...
      return assign({}, ...((function() {
        ...
        for (i = 0, len = facets.length; i < len; i++) {
          facet = facets[i];
          results.push({
            [`${facet.name}`]: _cast_attribute_value(facet.value)
          });
        }
        return results;
      })()));
