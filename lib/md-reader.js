(function() {
  ...
  this._PRE.$rewrite_markdownit_tokens = (function(_this) {
    return function(S) {
      ...
      return $(function(token, send) {
        var attribute_name, attribute_value, col_nr, extra, i, id, j, language_name, len, len1, line_nr, map, markup, meta, name, position, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, tag, text_meta, type;
        _send = send;
        if (token === end_token) {
