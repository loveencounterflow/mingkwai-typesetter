(function() {
  ...
  this._PRE.$rewrite_markdownit_tokens = (function(_this) {
    return function(S) {
      ...
      return $(function(token, send) {
        var attribute_name, attribute_value, col_nr, extra, i, id, language_name, len, line_nr, map, markup, meta, name, position, ref, ref1, ref2, ref3, ref4, text_meta, type;
        _send = send;
        if (token === end_token) {
          ...
          if (within_footnote_block || !S.has_ended) {
            switch (type) {
              ...
              case 'fence':
                ...
                break;
              case 'html_inline':
                ref4 = _this._parse_html_tag(token['content']), position = ref4[0], name = ref4[1], extra = ref4[2];
                switch (position) {
                  case 'comment':
