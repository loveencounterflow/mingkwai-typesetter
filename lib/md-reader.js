(function() {
  ...
  this._PRE.$rewrite_markdownit_tokens = (function(_this) {
    return function(S) {
      ...
      return $(function(token, send) {
        var attribute_name, attribute_value, col_nr, extra, i, id, language_name, len, line_nr, map, markup, meta, name, position, ref, ref1, ref2, ref3, ref4, ref5, tag, text_meta, type;
        _send = send;
        if (token === end_token) {
          ...
          if (within_footnote_block || !S.has_ended) {
            switch (type) {
              ...
              case 'tr_close':
                debug('982342', token);
                ref4 = type.split('_'), tag = ref4[0], position = ref4[1];
              ...
              case 'fence':
                ...
                break;
              case 'html_inline':
                ref5 = _this._parse_html_tag(token['content']), position = ref5[0], name = ref5[1], extra = ref5[2];
                switch (position) {
                  case 'comment':
  ...
  this._PRE.$amend_tables = (function(_this) {
    return function(S) {
      ...
      alignments = [];
      return $(function(event, send) {
        var i, len, meta, name, past_event, table_meta, text, type, within_table;
        ...
        if (_this.select(event, '(', 'table')) {
          ...
          } else if (_this.select(event, '(', ['td', 'th'])) {
