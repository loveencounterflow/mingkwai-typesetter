(function() {
  ...
  this.create_md_readfitting = function(md_source, settings) {
    ...
    readstream.pipe(this._PRE.$flatten_tokens(S)).pipe(this._PRE.$reinject_html_blocks(S)).pipe(this._PRE.$rewrite_markdownit_tokens(S)).pipe(this.MACROS.$expand_command_and_value_macros(S)).pipe(this.MACROS.$expand_region_macros(S)).pipe(this.MACROS.$expand_action_macros(S)).pipe(this.MACROS.$expand_raw_macros(S)).pipe(this.MACROS.$expand_html_comments(S)).pipe(this.MACROS.$expand_escape_chrs(S)).pipe(this._PRE.$process_end_command(S)).pipe(this._PRE.$close_dangling_open_tags(S)).pipe(this._PRE.$consolidate_footnotes(S)).pipe(writestream);
    input.pause();
