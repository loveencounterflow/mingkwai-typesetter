(function() {
  var $, CND, D, Markdown_parser, alert, badge, debug, echo, fences_rxcc, get_parse_html_methods, help, info, log, misfit, name_rx, new_md_inline_plugin, njs_fs, njs_path, parse_methods, rpr, tracker_pattern, urge, warn, whisper,
  ...
  this.$write_mktscript = function(S, output) {
    var confluence, indentation, mkscript_locator, tag_stack, write;
    if (output == null) {
      output = null;
    }
    indentation = '';
