(function() {
  ...
  this._ESC.escape_macro_tags = (function(_this) {
    return function(S, text) {
      var R, discard_count, ref;
      ref = _this._ESC.truncate_text_at_end_command_macro(text), R = ref[0], discard_count = ref[1];
      if (discard_count > 0) {
        whisper("detected <<!end>> macro; discarding approx. " + discard_count + " characters");
      }
      R = _this._ESC.escape_escape_chrs(R);
      R = R.replace(_this._ESC.html_comment_pattern, function(_, $1, $2) {
        var key;
        key = _this._ESC.register_content(S, 'comment', $2);
    ...
    return (function(_this) {
      return function(md_source) {
        ...
        if (CND.isa_text(md_source)) {
          md_source = _this._ESC.escape_macro_tags(S, md_source);
          environment = {};
