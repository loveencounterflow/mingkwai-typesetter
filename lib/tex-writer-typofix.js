...
(function() {
  ...
  */
  var $, CND, D, MD_READER, MKNCR, alert, badge, copy, debug, echo, help, hide, info, is_hidden, is_stamped, jr, log, rpr, select, stamp, urge, warn, whisper, Σ_glyph_description,
    indexOf = [].indexOf;
