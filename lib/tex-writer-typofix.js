(function() {
  ...
  this._analyze_chr = function(S, chr) {
    ...
    characters
     */
    R.styled_chr = this._style_chr(S, R.rsg, chr);
    R.is_cjk = (ref = R.rsg, indexOf.call(S.cjk_rsgs, ref) >= 0);
    R.is_whitespace = indexOf.call(S.whitespace, chr) >= 0;
    return R;
  };

  this._style_chr = function(S, rsg, chr) {
    var R, ref, ref1, ref2, ref3, rpl_chr, rpl_cmd, rpl_push, rpl_raise, rsg_command, style;
    ...
    if (style != null) {
      R = [];
      R.push("\\cjkgGlue{");
      rpl_push = (ref = style['push']) != null ? ref : null;
      rpl_raise = (ref1 = style['raise']) != null ? ref1 : null;
      rpl_chr = (ref2 = style['glyph']) != null ? ref2 : chr;
      rpl_cmd = (ref3 = style['cmd']) != null ? ref3 : rsg_command;
      if (rpl_cmd === 'cn') {
        rpl_cmd = null;
      }
