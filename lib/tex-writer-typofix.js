(function() {
  ...
  this.fix_typography_for_tex = (function(_this) {
    return function(text, options, send) {
      var R, advance, advance_each_chr, advance_whitespace, chr, chunk, command, fncr, glyph_styles, has_cjk_glue, i, last_command, last_rsg, last_was_cjk, last_was_whitespace, len, message, ref, ref1, ref10, ref11, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, remark, replacement, rpl, rpl_chr, rpl_cmd, rpl_push, rpl_raise, rsg, tex_command_by_rsgs, this_is_cjk, this_is_whitespace, uchr, whitespace_cache;
      if (send == null) {
        send = null;
      }
      ...
      for (i = 0, len = ref5.length; i < len; i++) {
        ...
        if ((replacement = glyph_styles[chr]) != null) {
          ...
          rpl.push('{');
          rpl_push = (ref7 = replacement['push']) != null ? ref7 : null;
          rpl_raise = (ref8 = replacement['raise']) != null ? ref8 : null;
          rpl_chr = (ref9 = replacement['glyph']) != null ? ref9 : chr;
          rpl_cmd = (ref10 = replacement['cmd']) != null ? ref10 : null;
          if (rpl_cmd === 'cn') {
            rpl_cmd = null;
          }
        ...
        if ((command = tex_command_by_rsgs[rsg]) == null) {
          command = (ref11 = tex_command_by_rsgs['fallback']) != null ? ref11 : null;
