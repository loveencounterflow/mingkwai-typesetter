...
(function() {
  var $, CND, D, MD_READER, MKNCR, XNCHR, _X_, alert, badge, copy, debug, echo, help, hide, info, is_hidden, is_stamped, log, rpr, select, stamp, urge, warn, whisper,
  ...
  this.fix_typography_for_tex = (function(_this) {
    return function(text, options, send, style) {
      var S, chr, chrs, cid, csg, dangling_ws, description, i, idx, last_idx, len, open_bracket_count, ref, ref1, ref2, ref3, ref4, ref5, ref6, tex, tex_block, tex_codepoint;
      if (send == null) {
        send = null;
      }
      S = {
      ...
      ref = _this._split_dangling_ws(text), text = ref[0], dangling_ws = ref[1];
      ...
      for (idx = i = 0, len = chrs.length; i < len; idx = ++i) {
        ...
        chr = description.chr, csg = description.csg, cid = description.cid, tex = description.tex;
        tex_block = (ref1 = tex != null ? tex['block'] : void 0) != null ? ref1 : null;
        tex_codepoint = (ref2 = tex != null ? tex['codepoint'] : void 0) != null ? ref2 : null;
        debug('79011', (ref3 = (ref4 = description['tex']) != null ? ref4['block'] : void 0) != null ? ref3 : '', (ref5 = (ref6 = description['tex']) != null ? ref6['codepoint'] : void 0) != null ? ref5 : '', description['uchr']);
        if (tex_block != null) {
          open_bracket_count += +1;
          _this._push(S, "{");
          _this._push(S, tex_block);
          _this._push(S, "{}");
        }
        if (tex_codepoint != null) {
          _this._push(S, tex_codepoint);
        } else {
          _this._push(S, chr);
        }
