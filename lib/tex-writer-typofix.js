(function() {
  ...
  this._style_chr = function(S, chr_info, chr, is_last) {
    var R, _XXX_use_cxltx_pushraise, csg, fncr, is_cjk, message, ref, ref1, ref2, ref3, ref4, rpl_chr, rpl_cmd, rpl_push, rpl_raise, rsg, rsg_command, style;
    ...
    if (style != null) {
      ...
      results
       */
      if (_XXX_use_cxltx_pushraise = true) {
      ...
      R.push(rpl_chr);
      if (_XXX_use_cxltx_pushraise && ((rpl_push != null) || (rpl_raise != null))) {
        R.push("}");
      }
      R.push("}");
      R = R.join('');
