(function() {
  ...
  this._split_dangling_ws.pattern = /^([\s\S]*?)(\s*)$/;

  this.fix_typography_for_tex = (function(_this) {
    return function(text, options, send, style) {
      var A, S, chr, chrs, danglin_ws, i, idx, last_idx, len, ref, ref1, ref2, ref3, ref4, ref5;
      if (send == null) {
        send = null;
      }
      S = {
      ...
      ref5 = _this._split_dangling_ws(text), text = ref5[0], danglin_ws = ref5[1];
