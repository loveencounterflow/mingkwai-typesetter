...
(function() {
  var $, CND, D, MD_READER, MKNCR, XNCHR, alert, badge, copy, debug, echo, help, hide, info, is_hidden, is_stamped, log, rpr, select, stamp, urge, warn, whisper,
  ...
  this.fix_typography_for_tex = (function(_this) {
    return function(text, options, send, style) {
      var S, chr, chrs, cid, csg, dangling_ws, description, i, idx, last_idx, len, ref, ref1, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9;
      if (send == null) {
        send = null;
      }
      S = {
      ...
      for (idx = i = 0, len = chrs.length; i < len; idx = ++i) {
        chr = chrs[idx];
        description = _this._analyze_chr(S, chr, style, idx === last_idx);
        debug('79011', (ref6 = (ref7 = description['tex']) != null ? ref7['block'] : void 0) != null ? ref6 : '', (ref8 = (ref9 = description['tex']) != null ? ref9['codepoint'] : void 0) != null ? ref8 : '', description['uchr']);

        /* ****************************** */
        csg = description.csg, cid = description.cid;
        ...
        if (description.styled_chr != null) {
          _this._push(S, description.styled_chr);
        } else {
          _this._push(S, description.chr);
        }
      }
