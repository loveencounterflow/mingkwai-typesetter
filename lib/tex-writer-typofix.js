(function() {
  ...
  this.fix_typography_for_tex = (function(_this) {
    return function(text, options, send) {
      var R, advance, advance_each_chr, advance_whitespace, chr, chunk, command, fncr, glyph_styles, glyph_styles_v2, i, last_command, last_rsg, last_was_cjk, last_was_whitespace, len, message, ref, ref1, ref10, ref11, ref12, ref13, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, remark, replacement, rpl, rpl_chr, rpl_cmd, rpl_push, rpl_raise, rsg, tex_command_by_rsgs, this_is_cjk, this_is_whitespace, uchr, whitespace_cache;
      if (send == null) {
        send = null;
      }
      ...
      if (whitespace_cache.length > 0) {
        debug('©324-4', rpr(chr), whitespace_cache);
      }
      if (whitespace_cache.length > 0) {
        advance_whitespace();
      }
