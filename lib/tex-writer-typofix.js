(function() {
  ...
  this.fix_typography_for_tex = (function(_this) {
    return function(text, options, send) {
      var R, advance, advance_each_chr, chr, chunk, command, fncr, glyph_styles, glyph_styles_v2, i, is_latin_whitespace, last_command, last_rsg, last_was_cjk, len, message, ref, ref1, ref10, ref11, ref12, ref13, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, remark, replacement, rpl, rpl_chr, rpl_cmd, rpl_push, rpl_raise, rsg, tex_command_by_rsgs, this_is_cjk, uchr;
      if (send == null) {
        send = null;
      }
