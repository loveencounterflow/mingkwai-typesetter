(function() {
  "use strict";
  var CLOAK, CND, DIFF, alert, badge, cloak, cloaked_text, debug, echo, esc_re, help, info, log, rainbow, ref, rpr, start_chr, stop_chr, text, uncloaked_text, urge, warn, whisper;
  ...
  this._mixin_backslashed = function(cloak, base) {
    ...
    _tsp_backslash = RegExp((esc_re(start_chr)) + "([0-9a-f]+)" + (esc_re(stop_chr)), "g");
  ...
  if (module.parent == null) {
    ...
    help(cloak);
    ref = cloak['cloaked'], start_chr = ref[0], stop_chr = ref[1];
