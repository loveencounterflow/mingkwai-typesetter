(function() {
  ...
  this["MKTS.MACROS.escape.action_and_region_macros (1: regions)"] = function(T, done) {
    var S, i, len, probe, probes_and_matchers, ref, registry_matcher, text_matcher, text_result;
    probes_and_matchers = [
      ["some text here <<(>>and some there<<)>>", null, null], [
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      text_result = MKTS.MACROS.escape.action_and_region_macros(S, probe);
  ...
  this["MKTS.MACROS.escape.action_and_region_macros (2: actions)"] = function(T, done) {
    var S, i, len, probe, probes_and_matchers, ref, registry_matcher, text_matcher, text_result;
    probes_and_matchers = [
      [
        "<<(.>><<)>>", "\u0015action0\u0013", [
