(function() {
  ...
  this["MKTS.TEX_WRITER.tex_from_md (2)"] = function(T, done) {
    ...
    matcher = "% begin of MD document\nThe \\LaTeX{} Logo: {\\mktsStyleCode{}\\LaTeX{}} The \\\\LaTeX{} Logo: {\\mktsStyleCode{}\\\\LaTeX{}}\\mktsShowpar\\par\n\n% end of MD document\n";
    return step((function(_this) {
      return function*(resume) {
        var result;
        result = (yield MKTS.TEX_WRITER.tex_from_md(probe, settings, resume));
  ...
  this["TEX_WRITER.fix_typography_for_tex"] = function(T, done) {
    ...
    probes_and_matchers = [["Brick tea ! ", "Brick tea ! "], ["&\\#", "\\&\\textbackslash{}\\#"], ["國", "{\\cjk{}國}"], ["Brick tea 紧压茶都是用红茶 is delicious", "Brick tea {\\cjk{}紧压茶都是用红茶} is delicious"], ["Brick tea\n紧压茶都 是\t\n用红茶 is\ndelicious", "Brick tea\n{\\cjk{}紧压茶都 是\t\n用红茶} is\ndelicious"], ["Brick tea 紧压茶卩癶都是用红茶 is delicious", "Brick tea {\\cjk{}紧压茶\\cjkgGlue{\\tfPush{-0.4}卩\\cjkgGlue}{\\tfRaise{-0.2}\\cnxBabel{}癶\\cjkgGlue}{\\tfRaise{0.1}\\cnxJzr{}\\cjkgGlue}都是用红茶} is delicious"], ["压茶卩红茶", "{\\cjk{}压茶\\cjkgGlue{\\tfPush{-0.4}卩\\cjkgGlue}红茶}"], ["压茶𠇋卩红茶", "{\\cjk{}压茶{\\cnxb{}𠇋}\\cjkgGlue{\\tfPush{-0.4}卩\\cjkgGlue}红茶}"], ["压茶𠇋卩", "{\\cjk{}压茶{\\cnxb{}𠇋}\\cjkgGlue{\\tfPush{-0.4}卩\\cjkgGlue}}"]];
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
