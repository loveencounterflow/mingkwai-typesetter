(function() {
  ...
  this["MKTS.MACROS.escape 1"] = function(T, done) {
    var S, i, len, probe, probes_and_matchers, ref, registry_matcher, text_matcher, text_result;
    probes_and_matchers = [
      [
  ...
  this["MKTS.MACROS.escape 2"] = function(T, done) {
    var S, i, len, probe, probes_and_matchers, ref, text_matcher, text_result;
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ref = probes_and_matchers[i], probe = ref[0], text_matcher = ref[1];
      S = MKTS.MACROS.initialize_state({});
      text_result = MKTS.MACROS.escape(S, probe);
  ...
  this["MKTS.MACROS.$expand_actions"] = function(T, done) {
    var S, i, input, len, matcher, pre_probe, probe, probes_and_matchers, ref, results, stream;
    probes_and_matchers = [
      [
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      D.call_transform(stream, ((function(_this) {
        return function() {
          return MKTS.MACROS.$expand_actions(S);
        };
      })(this)), (function(_this) {
        return function(error, result) {
          var event, j, len1;
  ...
  this["MKTS.MACROS.$expand_raw_spans"] = function(T, done) {
    var S, i, input, len, matcher, pre_probe, probe, probes_and_matchers, ref, results, stream;
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      D.call_transform(stream, ((function(_this) {
        return function() {
          return MKTS.MACROS.$expand_raw_spans(S);
        };
      })(this)), (function(_this) {
        return function(error, result) {
          var event, j, len1;
  ...
  this["MKTS.MACROS.$expand_commands_and_values"] = function(T, done) {
    var S, i, input, len, matcher, pre_probe, probe, probes_and_matchers, ref, results, stream;
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      D.call_transform(stream, ((function(_this) {
        return function() {
          return MKTS.MACROS.$expand_commands_and_values(S);
        };
      })(this)), (function(_this) {
        return function(error, result) {
          var event, j, len1;
