(function() {
  ...
  this["MKTS.MACROS.action_patterns match action macros"] = function(T, done) {
  ...
  this["MKTS.MKTSCRIPT_WRITER.mkts_events_from_md (4)"] = function(T, done) {
    ...
    probe = "<<!end>>";
    warn("match remark?");
    matcher = [["(", "document", null, {}], [".", "action", "empty-document", {}], [")", "document", null, {}]];
    return step((function(_this) {
      return function*(resume) {
        var result;
        result = (yield MKTS.MKTSCRIPT_WRITER.mkts_events_from_md(probe, settings, resume));
