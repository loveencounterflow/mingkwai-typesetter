(function() {
  ...
  this["MKTS.MACRO_ESCAPER.$expand_html_comments"] = function(T, done) {
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      D.call_transform(stream, ((function(_this) {
        return function() {
          return MKTS.MACRO_ESCAPER.$expand_html_comments(S);
        };
      })(this)), (function(_this) {
  ...
  this["MKTS.MACRO_ESCAPER.$expand_action_macros"] = function(T, done) {
    var S, i, input, len, matcher, pre_probe, probe, probes_and_matchers, ref, results, stream;
    probes_and_matchers = [
      [
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      D.call_transform(stream, ((function(_this) {
        return function() {
          return MKTS.MACRO_ESCAPER.$expand_action_macros(S);
        };
      })(this)), (function(_this) {
        return function(error, result) {
          var event, j, len1;
  ...
  this["MKTS.MACRO_ESCAPER.$expand_raw_macros"] = function(T, done) {
    var S, i, input, len, matcher, pre_probe, probe, probes_and_matchers, ref, results, stream;
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      D.call_transform(stream, ((function(_this) {
        return function() {
          return MKTS.MACRO_ESCAPER.$expand_raw_macros(S);
        };
      })(this)), (function(_this) {
        return function(error, result) {
          var event, j, len1;
  ...
  this["MKTS.MACRO_ESCAPER.$expand_command_and_value_macros"] = function(T, done) {
    var S, i, input, len, matcher, pre_probe, probe, probes_and_matchers, ref, results, stream;
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      D.call_transform(stream, ((function(_this) {
        return function() {
          return MKTS.MACRO_ESCAPER.$expand_command_and_value_macros(S);
        };
      })(this)), (function(_this) {
        return function(error, result) {
          var event, j, len1;
  ...
  this["MKTS.MACRO_ESCAPER.$expand_region_macros"] = function(T, done) {
    var S, i, input, len, matcher, pre_probe, probe, probes_and_matchers, ref, results, stream;
    ...
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ...
      D.call_transform(stream, ((function(_this) {
        return function() {
          return MKTS.MACRO_ESCAPER.$expand_region_macros(S);
        };
      })(this)), (function(_this) {
        return function(error, result) {
          var event, j, len1;
  ...
  this["MKTS.MKTSCRIPT_WRITER.mkts_events_from_md (1)"] = function(T, done) {
    ...
    matcher = [
      [
        ...
        ".", "warning", "line 1: vocal is not defined", {
          "line_nr": 1,
          "col_nr": 2,
          "markup": "",
          "mode": "vocal",
