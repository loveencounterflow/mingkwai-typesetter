(function() {
  ...
  this["_TEX_WRITER_TYPOFIX.fix_typography_for_tex"] = function(T, done) {
    ...
    probes_and_matchers = [["國", "{\\cjk{}國}"], ["x國x", "x{\\cjk{}國}x"], ["a 國 b", "a {\\cjk{}國} b"], ["𠇋", "{\\cjk{}{\\cnxb{}𠇋}}"], ["x𠇋x", "x{\\cjk{}{\\cnxb{}𠇋}}x"], ["a 𠇋 b", "a {\\cjk{}{\\cnxb{}𠇋}} b"], ["卩", "{\\cjk{}{\\tfPush{-0.4}卩}}"], ["x卩x", "x{\\cjk{}{\\tfPush{-0.4}卩}}x"], ["x 卩 x", "x {\\cjk{}{\\tfPush{-0.4}卩}} x"]];
  ...
  this["TEX_WRITER_TYPOFIX.fix_typography_for_tex_2"] = function(T, done) {
    ...
    options_home = njs_path.dirname(options_locator);
    S.options = OPTIONS.from_locator(options_locator);
    probes_and_matchers = [["Brick tea ! ", "Brick tea ! "], ["&\\#", "\\&\\textbackslash{}\\#"], ["國", "{\\cjk{}國}"], ["x國x", "x{\\cjk{}國}x"], ["a 國 b", "a {\\cjk{}國} b"], ["國 國", "{\\cjk{}國 國}"], ["𠇋", "{\\cjk{}{\\cnxb{}𠇋}}"], ["x𠇋x", "x{\\cjk{}{\\cnxb{}𠇋}}x"], ["a 𠇋 b", "a {\\cjk{}{\\cnxb{}𠇋}} b"], ["卩", "{\\cjk{}\\cjkgGlue{\\tfPush{-0.4}卩\\cjkgGlue}}"], ["x卩x", "x{\\cjk{}\\cjkgGlue{\\tfPush{-0.4}卩\\cjkgGlue}}x"], ["x 卩 x", "x {\\cjk{}\\cjkgGlue{\\tfPush{-0.4}卩\\cjkgGlue}} x"], ["x 國卩國𠇋 x", "x {\\cjk{}國\\cjkgGlue{\\tfPush{-0.4}卩\\cjkgGlue}國{\\cnxb{}𠇋}} x"], ["x𠇋𠇋𠇋x", "x{\\cjk{}{\\cnxb{}𠇋}{\\cnxb{}𠇋}{\\cnxb{}𠇋}}x"], ["Brick tea 紧压茶都是用红茶 is delicious", "Brick tea {\\cjk{}紧压茶都是用红茶} is delicious"], ["Brick tea\n紧压茶都 是\t\n用红茶 is\ndelicious", "Brick tea\n{\\cjk{}紧压茶都 是\t\n用红茶} is\ndelicious"], ["Brick tea 紧压茶卩癶都是用红茶 is delicious", "Brick tea {\\cjk{}紧压茶\\cjkgGlue{\\tfPush{-0.4}卩\\cjkgGlue}{\\tfRaise{-0.2}\\cnxBabel{}癶\\cjkgGlue}{\\tfRaise{0.1}\\cnxJzr{}\\cjkgGlue}都是用红茶} is delicious"], ["压茶卩红茶", "{\\cjk{}压茶\\cjkgGlue{\\tfPush{-0.4}卩\\cjkgGlue}红茶}"], ["压茶𠇋卩红茶", "{\\cjk{}压茶{\\cnxb{}𠇋}\\cjkgGlue{\\tfPush{-0.4}卩\\cjkgGlue}红茶}"], ["压茶𠇋卩", "{\\cjk{}压茶{\\cnxb{}𠇋}\\cjkgGlue{\\tfPush{-0.4}卩\\cjkgGlue}}"]];
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      ref1 = probes_and_matchers[i], probe = ref1[0], matcher = ref1[1];
