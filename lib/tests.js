(function() {
  var $, $async, CND, D, MKTS, MKTSCRIPT, TEX, after, alert, badge, copy_regex_non_global, debug, echo, help, info, join, later, list_from_match, log, match_first, nice_text_rpr, njs_path, rpr, show_events, step, suspend, test, urge, warn, whisper;
  ...
  this["MKTS.TRACKER.new_tracker().track rejects unregistered pattern"] = function(T, done) {
    var track;
  ...
  this["MKTSCRIPT.mkts_events_from_md (1)"] = function(T, done) {
    var matcher, probe;
  ...
  this["MKTSCRIPT.mkts_events_from_md (2)"] = function(T, done) {
  ...
  this["MKTSCRIPT.mkts_events_from_md (3)"] = function(T, done) {
    var matcher, probe, settings;
    settings = {
      bare: true
    };
  ...
  this["MKTSCRIPT.mkts_events_from_md (4)"] = function(T, done) {
    var matcher, probe, settings;
    settings = {
      bare: false
    };
  ...
  this["MKTSCRIPT.mkts_events_from_md (5)"] = function(T, done) {
    var matcher, probe, settings;
    settings = {
      bare: true
    };
  ...
  this["MKTSCRIPT.mkts_events_from_md (6)"] = function(T, done) {
    var matcher, probe, settings;
    settings = {
      bare: true
    };
  ...
  this["MKTSCRIPT.mkts_events_from_md (7)"] = function(T, done) {
    var matcher, probe, settings;
    settings = {
      bare: true
    };
  ...
  this["MKTSCRIPT.mkts_events_from_md (8)"] = function(T, done) {
    var matcher, probe, settings;
    settings = {
      bare: true
    };
  ...
  this["MKTSCRIPT.mkts_events_from_md: footnotes"] = function(T, done) {
    var matcher, probe, settings;
    settings = {
      bare: true
    };
  ...
  this["TEX.tex_from_md (1)"] = function(T, done) {
    var matcher, probe, settings;
    settings = {
      bare: true
    };
  ...
  this["MKTSCRIPT.mktscript_from_md (1)"] = function(T, done) {
    var matcher, probe, settings;
    settings = {
      bare: true
    };
  ...
  this["MKTSCRIPT.mktscript_from_md (2)"] = function(T, done) {
    var matcher, probe, settings;
    settings = {
      bare: true
    };
