(function() {
  ...
  this["TEX_WRITER.fix_typography_for_tex"] = function(T, done) {
    ...
    probes_and_matchers = [["Brick tea ! ", "Brick tea ! "], ["&\\#", "\\&\\textbackslash{}\\#"], ["國", "{\\cjk{}國}"], ["Brick tea 紧压茶都是用红茶 is delicious", "Brick tea {\\cjk{}紧压茶都是用红茶} is delicious"], ["Brick tea\n紧压茶都 是\t\n用红茶 is\ndelicious", "Brick tea\n{\\cjk{}紧压茶都 是\t\n用红茶} is\ndelicious"], ["Brick tea 紧压茶卩癶都是用红茶 is delicious", "Brick tea {\\cjk{}紧压茶{\\tfPush{-0.4}卩}{\\tfRaise{-0.2}\\cnxBabel{}癶}{\\tfRaise{0.1}\\cnxJzr{}}都是用红茶} is delicious"], ["压茶卩红茶", "{\\cjk{}压茶{\\tfPush{-0.4}卩}红茶}"], ["压茶𠇋卩红茶", "{\\cjk{}压茶{\\cnxb{}𠇋}{\\tfPush{-0.4}卩}红茶}"]];
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
