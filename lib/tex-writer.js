(function() {
  var $, $async, ASYNC, CACHE, CND, CUSTOM, D, HELPERS, LINEBREAKER, MACRO_ESCAPER, MD_READER, MKTS, MKTSCRIPT_WRITER, OPTIONS, SEMVER, TEXLIVEPACKAGEINFO, XNCHR, after, alert, badge, before, copy, debug, echo, help, hide, info, is_hidden, is_stamped, log, njs_fs, njs_path, options_route, ref, rpr, select, stamp, step, suspend, unstamp, urge, warn, whisper, ƒ,
    slice = [].slice;
      ...
      $most_frequent = function(S) {
        return $async(function(event, done) {
          ...
          return step(function*(resume) {
            ...
            glyphs = glyphs.join('');
            return done(stamp(['.', 'text', glyphs, copy(meta)]));
          });
        });
      };
