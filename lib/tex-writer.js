...
(function() {
  ...
  this.MKTX.COMMAND.$crossrefs = (S) => {
    ...
    return $((event, send, end) => {
      var count, key, meta, name, ref, text, type;
      if (event != null) {
        // debug '8624', event
        [type, name, text, meta] = event;
        //.......................................................................................................
        if (select(event, '!', ['crossref-source'])) {
          ...
          count = crossrefs[text] = ((ref = crossrefs[text]) != null ? ref : 0) + 1;
          key = `${text}-${count}`;
          send(['tex', `\\zlabel{${key}}`]);
          send(stamp(event));
        } else {
