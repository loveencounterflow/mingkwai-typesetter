...
(function() {
  //###########################################################################################################
  var $, $async, ASYNC, AUX, CACHE, CND, D, HELPERS, LINEBREAKER, MACRO_ESCAPER, MACRO_INTERPRETER, MD_READER, MKTS, MKTSCRIPT_WRITER, OPTIONS, PIPEDREAMS, SEMVER, TEXLIVEPACKAGEINFO, TEXT, TW, XNCHR, after, alert, badge, before, copy, debug, echo, help, hide, info, is_hidden, is_stamped, jr, log, njs_fs, njs_path, options_route, promisify, rpr, select, stamp, step, suspend, unstamp, urge, warn, whisper, ƒ, Σ_formatted_warning,
    splice = [].splice,
    slice = [].slice;
...
// send [ '!', 'mark', 'toc', ( copy meta ), ]
  ...
  this.MKTX.INLINE.$fncr = (S) => {
    var buffer, pattern, within_fncr;
    within_fncr = false;
    buffer = [];
    pattern = /^([a-z])(?:-([a-z0-9][-a-z0-9]*))?[-\/]([0-9a-f]{1,6})$/;
    //.........................................................................................................
    return $((event, send) => {
      var _, cid, csg, match, meta, name, parameters, rsg, text, type;
      [type, name, parameters, meta] = event;
...
//.....................................................................................................
  ...
  if (module.parent == null) {
    ...
    require('../../mingkwai');
    (async function() {
      var mktscript, tex_source;
      mktscript = "# Headline\n\nSome *important* text. <box>boxed</box>\n";
      // mktscript = """<box>boxed</box>"""
      promisify = (require('util')).promisify;
      tex_source = (await (promisify(TW.tex_from_md.bind(TW)))(mktscript, {
        bare: true
      }));
