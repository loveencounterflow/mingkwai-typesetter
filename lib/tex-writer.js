...
(function() {
  //###########################################################################################################
  var $, $async, ASYNC, AUX, CACHE, CND, D, HELPERS, LINEBREAKER, MACRO_ESCAPER, MACRO_INTERPRETER, MD_READER, MKTS, MKTSCRIPT_WRITER, OPTIONS, PIPEDREAMS, SEMVER, TEXLIVEPACKAGEINFO, XNCHR, XXX_tex_from_md_nr, YADDA, after, alert, badge, before, copy, debug, echo, help, hide, info, is_hidden, is_stamped, jr, log, njs_fs, njs_path, options_route, promisify, rpr, select, stamp, step, suspend, unstamp, urge, warn, whisper, ƒ, Σ_formatted_warning,
    splice = [].splice,
    slice = [].slice;
...
// send [ '!', 'mark', 'toc', ( copy meta ), ]
  ...
  this.MKTX.INLINE.$code_span = (S) => {
    var within_code_span, within_smallcaps;
    ...
    return $((event, send) => {
      ...
      if (select(event, '(', ['smallcaps-lower'], true)) {
        send(event);
        return within_smallcaps = true;
      //.......................................................................................................
      } else if (select(event, ')', ['smallcaps-lower'], true)) {
        send(event);
        return within_smallcaps = false;
      //.......................................................................................................
