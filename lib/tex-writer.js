...
(function() {
  //###########################################################################################################
  var $, $async, ASYNC, AUX, CACHE, CND, D, HELPERS, LINEBREAKER, MACRO_ESCAPER, MACRO_INTERPRETER, MD_READER, MKTS, MKTSCRIPT_WRITER, OPTIONS, PIPEDREAMS, SEMVER, TEXLIVEPACKAGEINFO, TEXT, XNCHR, XXX_tex_from_md_nr, after, alert, badge, before, copy, debug, echo, help, hide, info, is_hidden, is_stamped, jr, log, njs_fs, njs_path, options_route, promisify, rpr, select, stamp, step, suspend, unstamp, urge, warn, whisper, ƒ, Σ_formatted_warning,
    splice = [].splice,
    slice = [].slice;
  ...
  this.write_mkts_master = function(S, handler) {
    ...
    return step(function*(resume) {
      var defs, filename, font_settings, font_settings_txt, fonts_home, fontspec_version, home, i, len, lines, main_font_name, name, newcommands, otf, ref, styles, subfolder, texname, text, use_new_syntax, value, write;
      lines = [];
    ...
    return $((event, send) => {
      ...
      if (select(event, '.', 'insert')) {
        ...
        switch ((ref = Q.mode) != null ? ref : 'literal') {
          ...
          case 'mkts':
            return send(['.', 'mktscript', content, copy(meta)]);
          case 'raw':
...
//.....................................................................................................
  ...
  this.pdf_from_md = async function(source_route, handler) {
    ...
    var RPC_SERVER, S, file_output, md_input, md_output, md_readstream, md_source, server, tex_input, tex_output, tex_writestream;
    ...
    S = {
      ...
      layout_info: HELPERS.new_layout_info(this.options, source_route),
      paragraph_nr: 0,
      configuration: {}
    };
    ...
    file_output.on('close', () => {
      return HELPERS.write_pdf(S.layout_info, (error) => {
