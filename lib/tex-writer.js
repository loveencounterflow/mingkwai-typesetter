(function() {
  ...
  CUSTOM.JZR.$most_frequent = (function(_this) {
    return function(S) {
      ...
      return D.TEE.from_pipeline([CUSTOM.JZR.$most_frequent.with_fncrs._$rewrite_events(S), CUSTOM.JZR.$most_frequent._$read(S), CUSTOM.JZR.$most_frequent.with_fncrs._$read(S), CUSTOM.JZR.$most_frequent.with_fncrs._$format(S), CUSTOM.JZR.$most_frequent.with_fncrs._$collect(S), CUSTOM.JZR.$most_frequent.with_fncrs._$assemble(S), CUSTOM.JZR.$most_frequent._$assemble(S)]);
    };
  })(this);
  ...
  CUSTOM.JZR.$most_frequent.with_fncrs._$format = (function(_this) {
    return function(S) {
  ...
  CUSTOM.JZR.$most_frequent.with_fncrs._$assemble = (function(_this) {
    return function(S) {
      ...
      this_glyph = null;
      return $(function(event, send) {
        var _, count, details, glyph, i, key, len, meta, ref1, text, value, value_txt, within_glyphs;
        within_glyphs = track.within('(glyphs-with-fncrs)');
        track(event);
