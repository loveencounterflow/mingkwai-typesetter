(function() {
  var $, $async, ASYNC, CACHE, CND, D, HELPERS, MD_READER, MKTS, MKTSCRIPT_WRITER, OPTIONS, SEMVER, TEXLIVEPACKAGEINFO, XNCHR, alert, badge, copy, debug, echo, help, hide, info, is_hidden, is_stamped, log, njs_fs, njs_path, options_route, ref, rpr, select, stamp, step, suspend, urge, warn, whisper, ƒ,
  ...
  this.MKTX.$show_unhandled_tags = (function(_this) {
    return function(S) {
      return $(function(event, send) {
        ...
        var event_txt, first, last, meta, name, ref1, text, type;
        if (((ref1 = event[0]) === 'tex' || ref1 === 'text') || select(event, '.', 'text')) {
          return send(event);
