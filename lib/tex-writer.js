(function() {
  ...
  this.MKTX.TEX.fix_typography_for_tex = (function(_this) {
    return function(text, options, send) {
      var R, advance, advance_each_chr, chr, chunk, command, fncr, glyph_styles, glyph_styles_v2, i, is_latin_whitespace, last_command, last_rsg, last_was_cjk, len, message, ref1, ref10, ref11, ref12, ref13, ref14, ref2, ref3, ref4, ref5, ref6, ref7, ref8, ref9, remark, replacement, rpl, rpl_chr, rpl_cmd, rpl_push, rpl_raise, rsg, tex_command_by_rsgs, this_is_cjk, uchr;
      if (send == null) {
        send = null;
      }
      ...
      glyph_styles_v2 = (ref3 = (ref4 = options['tex']) != null ? ref4['glyph-styles-v2'] : void 0) != null ? ref3 : {};
       ...
       */
      advance_each_chr = (ref5 = (ref6 = options['tex']) != null ? ref6['advance-each-chr'] : void 0) != null ? ref5 : false;
      tex_command_by_rsgs = (ref7 = options['tex']) != null ? ref7['tex-command-by-rsgs'] : void 0;
      last_command = null;
      R = [];
      chunk = [];
      last_rsg = null;
      ...
      for (i = 0, len = ref8.length; i < len; i++) {
        ...
        if ((replacement = glyph_styles_v2[chr]) != null) {
          advance();
          rpl = ['{'];
          rpl_push = (ref10 = replacement['push']) != null ? ref10 : null;
          rpl_raise = (ref11 = replacement['raise']) != null ? ref11 : null;
          rpl_chr = (ref12 = replacement['glyph']) != null ? ref12 : chr;
          rpl_cmd = (ref13 = replacement['cmd']) != null ? ref13 : null;
        ...
        if ((command = tex_command_by_rsgs[rsg]) == null) {
          command = (ref14 = tex_command_by_rsgs['fallback']) != null ? ref14 : null;
