...
(function() {
  //###########################################################################################################
  var $, $async, ASYNC, AUX, CACHE, CND, D, HELPERS, LINEBREAKER, MACRO_ESCAPER, MACRO_INTERPRETER, MD_READER, MKTS, MKTSCRIPT_WRITER, OPTIONS, OVAL, PIPEDREAMS, SEMVER, TEXLIVEPACKAGEINFO, UNITS, XNCHR, XXX_tex_from_md_nr, YADDA, after, alert, badge, before, copy, debug, echo, help, hide, info, is_hidden, is_stamped, jr, log, njs_fs, njs_path, options_route, promisify, rpr, select, stamp, step, suspend, unstamp, urge, warn, whisper, ƒ, Σ_formatted_warning,
    splice = [].splice,
    slice = [].slice;
  ...
  this.compile_options = function() {
    ...
    if (this.options.layout.lineheight != null) {
      this.options.layout.lineheight = UNITS.parse_nonnegative_quantity(this.options.layout.lineheight);
    }
    //.........................................................................................................
  ...
  this.write_mkts_master = function(S, handler) {
    var base, base1, base10, base2, base3, base4, base5, base6, base7, base8, base9, filename, font_settings, font_settings_txt, gkey, home, i, key, len, lines, mktsLineheight, mktsLineheight_txt, name, otf, ref, ref1, ref2, ref3, ref4, ref5, styles, subfolder, tex, texname, text, value, write;
    lines = [];
  ...
  this.MKTX.INLINE.$nudge = (S) => {
    ...
    return $((event, send) => {
      ...
      if (select(event, '(', 'nudge')) {
        ...
        send(stamp(event));
        return send(['tex', `{\\mktsPushRaise{${push}}{${raise}}`]);
      //.......................................................................................................
