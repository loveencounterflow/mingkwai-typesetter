(function() {
  ...
  this.MKTX.COMMAND.$single_and_multi_column = (function(_this) {
    return function(S) {
      return $(function(event, send) {
  ...
  this.MKTX.CLEANUP.$single_and_multi_column = (function(_this) {
    return function(S) {
