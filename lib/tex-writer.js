...
(function() {
  //###########################################################################################################
  var $, $async, ASYNC, AUX, CACHE, CND, D, HELPERS, LINEBREAKER, MACRO_ESCAPER, MACRO_INTERPRETER, MD_READER, MKTS, MKTSCRIPT_WRITER, OPTIONS, OVAL, PIPEDREAMS, SEMVER, TEXLIVEPACKAGEINFO, XNCHR, XXX_tex_from_md_nr, YADDA, after, alert, badge, before, copy, debug, echo, help, hide, info, is_hidden, is_stamped, jr, log, njs_fs, njs_path, options_route, promisify, rpr, select, stamp, step, suspend, unstamp, urge, warn, whisper, ƒ, Σ_formatted_warning,
    splice = [].splice,
    slice = [].slice;
...
// send [ '!', 'mark', 'toc', ( copy meta ), ]
  ...
  this.MKTX.INLINE.$scale = (S) => {
    ...
    return $((event, send) => {
      ...
      if (select(event, ['(', '.'], 'scale')) {
        ...
        brace = type === '(' ? '{' : '';
        return send(['tex', `${brace}\\${command}{${factor}}`]);
      //.......................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.MKTX.INLINE.$pushraise = (S) => {
    var schemas, validate_and_cast;
    schemas = {
      //.......................................................................................................
      pushraise: {
        properties: {
    ...
    return $((event, send) => {
      ...
      if (select(event, ['(', '.'], ['pushraise', 'push', 'raise'])) {
        ...
        switch (name) {
          case 'pushraise':
            return send(['tex', `${brace}\\mktsPushRaise{${Q.x}}{${Q.y}}`]);
          case 'push':
            return send(['tex', `${brace}\\mktsPush{${Q.x}}`]);
          case 'raise':
            return send(['tex', `${brace}\\mktsRaise{${Q.y}}`]);
        }
      //.......................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.MKTX.BLOCK.$loosen_and_tighten = (S) => {
  ...
  this.MKTX.BLOCK.$vspace = (S) => {
    ...
    return $((event, send) => {
      ...
      if (select(event, '.', 'vspace')) {
        ...
        //.....................................................................................................
        return send(['tex', `\\par\\${command}{${factor}}`]);
      } else {
        //.......................................................................................................
        return send(event);
      }
  ...
  this.MKTX.INLINE.$nudge = (S) => {
    ...
    return $((event, send) => {
      ...
      if (select(event, '(', 'nudge')) {
        ...
        send(stamp(event));
        return send(['tex', `{\\tfPushRaise{${push}}{${raise}}`]);
      //.......................................................................................................
