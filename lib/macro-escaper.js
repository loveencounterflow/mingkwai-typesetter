(function() {
  var $, CND, D, MKTS, alert, badge, debug, echo, help, info, log, njs_fs, njs_path, rpr, urge, warn, whisper;
    ...
    return function(S, text) {
      ...
      for (i = 0, len = ref.length; i < len; i++) {
        ...
        R = R.replace(pattern, function(_, markup, parameter_txt) {
          var content, error, error1, error_message, locator, ref1, result, route;
