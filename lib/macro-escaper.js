...
(function() {
  ...
  this.escape.bracketed_raw_macros = (S, text) => {
    ...
    for (i = 0, len = ref.length; i < len; i++) {
      ...
      R = R.replace(pattern, (_, markup, content) => {
        var id;
        id = this._register_content(S, 'raw', markup, content);
        return `\x15${id}\x13`;
      });
    }
    //.........................................................................................................
  ...
  this.escape.taggish_raw_macros = (S, text) => {
    var R, i, id, len, markup, match, matches, settings;
    R = [];
    markup = null;
    //.........................................................................................................
    settings = {
    ...
    for (i = 0, len = matches.length; i < len; i++) {
      ...
      switch (match.name) {
        ...
        case 'left':
          ...
          break;
        case 'match':
          id = this._register_content(S, 'raw', markup, match.value);
          R.push(`\x15${id}\x13`);
          break;
        case 'right':
          null;
