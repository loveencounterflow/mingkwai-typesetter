...
(function() {
  ...
  this.register_raw_tag = (tag_name) => {
    ...
    var start_tag, stop_tag;
    start_tag = `<${tag_name}>`;
    stop_tag = `</${tag_name}>`;
    return this._raw_tags.push([tag_name, start_tag, stop_tag]);
  };
  ...
  this.escape.taggish_raw_macros = (S, text) => {
    var i, id, j, len, len1, markup, match, matches, parts, ref, settings, start_tag, stop_tag, tag_name;
    parts = [];
    markup = null;
    //.........................................................................................................
    settings = {
    ...
    ref = this._raw_tags;
    for (i = 0, len = ref.length; i < len; i++) {
      [tag_name, start_tag, stop_tag] = ref[i];
