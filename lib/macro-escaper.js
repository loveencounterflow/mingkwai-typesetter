(function() {
  ...
  this.escape.escape_chrs = (function(_this) {
    return function(S, text) {
      ...
      R = R.replace(/\x11/g, '\x10B');
      R = R.replace(/\x15/g, '\x10X');
      R = R.replace(/\\((?:[\ud800-\udbff][\udc00-\udfff])|.)/g, function(_, $1) {
        var cid;
  ...
  this.escape.unescape_escape_chrs = (function(_this) {
    return function(S, text) {
      var R;
      R = text;
      R = R.replace(/\x11([0-9a-f]+);/g, function(_, $1) {
        var chr;
  ...
  this.$expand = function(S) {
    ...
    pipeline = [this.$expand_command_and_value_macros(S), this.$expand_region_macros(S), this.$expand_action_macros(S), this.$expand_raw_macros(S), this.$expand_html_comments(S), this.$expand_escape_chrs(S)];
    settings = {
      S: S
    };
  ...
  this.$expand_escape_illegals = (function(_this) {
    return function(S) {
      return $(function(event, send) {
