(function() {
  ...
  this.$expand = function(S) {
    ...
    pipeline = [this.$expand.$command_and_value_macros(S), this.$expand.$comma_macros(S), this.$expand.$region_macros(S), this.$expand.$action_macros(S), this.$expand.$raw_macros(S), this.$expand.$html_comments(S), this.$expand.$escape_chrs(S)];
    settings = {
      S: S
    };
  ...
  this.$expand.$region_macros = (function(_this) {
    return function(S) {
      ...
      return _this._get_expander(S, _this.region_id_pattern, function(meta, entry) {
        var expected, markup, message, raw;
