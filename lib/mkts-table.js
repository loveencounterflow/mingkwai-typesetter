...
(function() {
  'use strict';
  var $, $async, CND, D, ECS, IG, MD_READER, MKTS, UNITS, _TMP_BORDERSEGMENTS, _fail, _record, _record_fail, _stackerr, alert, badge, contains, copy, debug, echo, help, hide, info, is_hidden, is_stamped, jr, log, rpr, select, stamp, tex, texr, unstamp, urge, warn, whisper,
    indexOf = [].indexOf;
...
//.........................................................................................................
  ...
  this._walk_opening_events = function*(me, layout_name_stack, field_selector_stack) {
    ...
    if (me.debug) {
      yield texr('ð1001', "\\mktsColorframebox{green}{% debugging framebox");
    }
  ...
  this._walk_closing_events = function*(me) {
    ...
    if (me.debug) {
      yield texr('ð1007', "}% debugging framebox");
    }
