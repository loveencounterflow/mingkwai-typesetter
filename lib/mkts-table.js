...
(function() {
  'use strict';
  var $, $async, CND, D, ECS, IG, MD_READER, MKTS, _fail, _record, _record_fail, _stackerr, alert, badge, copy, debug, echo, help, hide, info, is_hidden, is_stamped, jr, log, rpr, select, stamp, tex, texr, unstamp, urge, warn, whisper,
    indexOf = [].indexOf;
  ...
  this.fieldborder = function(me, text) {
    var base, d, edge, field, i, j, len, len1, ref1, ref2;
    ...
    for (i = 0, len = ref1.length; i < len; i++) {
      ...
      for (j = 0, len1 = ref2.length; j < len1; j++) {
        edge = ref2[j];
        ((base = me.fieldborders)[field] != null ? base[field] : base[field] = {})[edge] = d.style;
      }
    }
    //.........................................................................................................
    return null;
  ...
  this._parse_fieldborder = function(me, fieldborder) {
    var _, cellkeys, d, edge, edges, fieldhint, fieldhints, fields, groups, i, len, ref1, style, type;
    ...
    if (fieldhints.has('*')) {
      ...
      if (fieldhints.has('table')) {
        ...
        for (i = 0, len = edges.length; i < len; i++) {
          edge = edges[i];
          ref1 = IG.GRID.walk_edge_cellrefs(me.grid, edge);
          for (d of ref1) {
  ...
  this._right_from_colnr = function(me, colnr) {
    return (this._left_from_colnr(me, colnr)) + me.cellwidths[colnr];
  };
  ...
  this._bottom_from_rownr = function(me, rownr) {
    return (this._top_from_rownr(me, rownr)) + me.cellheights[rownr];
  };
