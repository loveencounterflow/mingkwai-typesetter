...
(function() {
  ...
  this._new_description = function(S) {
    ...
    R = {
      ...
      /* which cells belong to what fields, by cell designations */cell_dimensions: {},
      fieldborders: {},
      /* field borders, as TikZ styles by sides */field_dimensions: {},
      /* field extents in terms of (unitwidth,unitheight), by designations */border_dimensions: {},
      /* border extents in terms of (unitwidth,unitheight), by designations */pod_dimensions: {},
      /* pod extents in terms of (unitwidth,unitheight), by designations */cellwidths: [null],
  ...
  this._walk_pod_events = function*(me) {
    var d, designation, fieldcells, ref1;
    ref1 = me.fieldcells;
    for (designation in ref1) {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this._walk_table_edge_fieldnames = function*(me, edge) {
    var d, fieldname, fieldnames, i, len, ref1, seen_fieldnames;
    seen_fieldnames = new Set();
    ref1 = this._walk_table_edge_cells(me, edge);
    for (d of ref1) {
      if ((fieldnames = me.cellfields[d.cellkey]) == null) {
        continue;
      }
      for (i = 0, len = fieldnames.length; i < len; i++) {
        fieldname = fieldnames[i];
        if (seen_fieldnames.has(fieldname)) {
          continue;
        }
