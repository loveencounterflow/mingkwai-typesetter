...
(function() {
  ...
  this._walk_pod_events = function*(me, fieldhints_and_content_events) {
    ...
    for (z of ref1) {
      ...
      /* TAINT throw error on unknown fieldhint */
      //     throw new Error "(MKTS/TABLE 5822) found content for unknown field #{rpr field_designation}"
      /* TAINT doesn't honor multiple fields with different dimensions for field_designation */
