...
(function() {
  ...
  this._parse_fieldborder = function(me, fieldborder) {
    var _, d, edge, edges, fieldhint_set, fieldhints, fieldnames, groups, i, len, ref1, style, type;
    ...
    fieldhint_set = new Set((function() {
      var i, len, ref1, results;
    ...
    if (fieldhint_set.has('*')) {
      ...
      if (fieldhint_set.has('table')) {
        ...
        for (i = 0, len = edges.length; i < len; i++) {
          ...
          for (d of ref1) {
            fieldhint_set.add(d.cellkey);
          }
        }
      }
      fieldnames = this._fieldnames_from_hints(me, fieldhint_set);
    }
    //.........................................................................................................
  ...
  this._walk_opening_events = function*(me) {
    ...
    if (me.debug) {
      yield texr('µ2', "\\mktsColoredFramebox{red}{% debugging framebox");
    }
  ...
  //-----------------------------------------------------------------------------------------------------------
  this._fieldnames_from_hints = function(me, fieldhints) {
    var R, cellfields, cellref, fieldhint, fieldname, i, len, ref1;
    R = new Set();
    for (fieldhint of fieldhints) {
      ref1 = IG.GRID.walk_cells_from_key(me.grid, fieldhint);
      for (cellref of ref1) {
        if ((cellfields = me.cellfields[cellref.cellkey]) == null) {
          continue;
        }
        for (i = 0, len = cellfields.length; i < len; i++) {
          fieldname = cellfields[i];
          R.add(fieldname);
        }
      }
    }
