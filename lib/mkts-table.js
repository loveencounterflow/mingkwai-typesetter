...
(function() {
  ...
  this._parse_cellborder = function(me, cellborder) {
    var _, cells, groups, quads, sides, style, type;
    ...
    cells = indexOf.call(quads, '*') >= 0 ? Object.keys(me.cellquads) : this._cellnames_from_quadkeys(me, (function() {
  ...
  this._cellnames_from_quadkeys = function(me, quadkeys) {
    var R, cellname, i, j, len, len1, quadkey, ref1;
    R = new Set();
