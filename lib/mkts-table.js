...
(function() {
  ...
  this._walk_pod_events = function*(me, selectors_and_content_events) {
    var _ref, content, d, halign_tex, i, len, ref1, ref2, ref3, ref4, ref5, selector, sub_event, table_height_txt, table_width_txt, valign_tex, z;
    table_height_txt = UNITS.as_text(me.unitheight, '*', me.table_dimensions.height);
    ...
    for (z of ref1) {
      ...
      yield texr('ð19', `\\begin{minipage}[t][${table_height_txt}][${valign_tex}]{${table_width_txt}}${halign_tex}%${_ref}`);
      yield ['.', 'noindent', null, {}];
