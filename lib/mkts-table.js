...
(function() {
  ...
  this.fieldcells = function(me, source) {
    var alias, aliases, base, base1, d, fieldcell, fieldnr, i, len, match, name, ref1, selector;
    this._ensure_grid(me);
    //.........................................................................................................
...
//.........................................................................................................
  ...
  this._resolve_aliases = function(me, selector) {
    var R, alias, bottomright, d, fieldnr, fieldnrs, i, j, len, len1, topleft;
    ...
    for (i = 0, len = selector.length; i < len; i++) {
      ...
      if ((fieldnrs = me.fieldnrs_by_aliases[alias]) == null) {
...
/* TAINT this should be an INTERGRID method */
      for (j = 0, len1 = fieldnrs.length; j < len1; j++) {
        fieldnr = fieldnrs[j];
        d = me.fieldcells[fieldnr];
        topleft = IG.CELLS.get_cellkey(me.grid, {
          colnr: d.left_colnr,
          rownr: d.top_rownr
        });
        bottomright = IG.CELLS.get_cellkey(me.grid, {
          colnr: d.right_colnr,
          rownr: d.bottom_rownr
        });
  ...
  this.fieldalignvertical = function(me, text) {
    ...
    ref1 = this._walk_fails_and_field_designations_from_selector(me, selector);
    //.........................................................................................................
    for (z of ref1) {
  ...
  // ITERATORS
  //-----------------------------------------------------------------------------------------------------------
  this._walk_fails_and_field_designations_from_selector = function*(me, selector) {
  ...
  this._walk_most_recent_field_designations = function*(me, fieldhints_and_stuff) {
    ...
    for (i = 0, len = fieldhints_and_stuff.length; i < len; i++) {
      ...
      ref1 = this._walk_fails_and_field_designations_from_selector(me, fieldhints);
      for (z of ref1) {
        [fail, field_designation] = z;
        if (fail != null) {
          _record(me, fail);
