...
(function() {
  'use strict';
  var $, $async, CND, D, ECS, EXCJSCC, MD_READER, MKTS, _fail, _record, _record_fail, _stackerr, alert, badge, copy, debug, echo, help, hide, info, is_hidden, is_stamped, jr, log, rpr, select, stamp, unstamp, urge, warn, whisper,
    indexOf = [].indexOf;
  ...
  // PUBLIC API
  //-----------------------------------------------------------------------------------------------------------
  this._set_gridsize = function(me, direction, text) {
    var match, p;
  ...
  this.gridwidth = function(me, text) {
    return this._set_gridsize(me, 'width', text);
  };

  this.gridheight = function(me, text) {
    return this._set_gridsize(me, 'height', text);
  };
  ...
  this.fieldalignvertical = function(me, text) {
    var _, fail, field_designation, fieldhints, match, ref1, type, value, z;
    if ((type = CND.type_of(text)) !== 'text') {
  ...
  this._walk_events = function*(me, fieldhints_and_content_events) {
    ...
    yield* this._walk_fail_events(me);
  };
  ...
  //-----------------------------------------------------------------------------------------------------------
  //.........................................................................................................
  this._walk_fail_events = function*(me) {
    var fail, i, len, ref1;
    ref1 = me.fails;
    for (i = 0, len = ref1.length; i < len; i++) {
      fail = ref1[i];
