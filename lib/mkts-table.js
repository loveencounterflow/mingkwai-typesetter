...
(function() {
  ...
  //-----------------------------------------------------------------------------------------------------------
  this.quadgrid = function(me, text) {
    var type;
    if ((type = CND.type_of(text)) !== 'text') {
    ...
    switch (text) {
      ...
      case 'false':
        ...
        break;
      default:
        throw new Error(`(MKTS/TABLE 9791) expected 'true' or 'false' for mkts-table/quadgrid, got a ${rpr(text)}`);
    }
    //.........................................................................................................
    return null;
  };
  ...
  this._walk_events = function*(me) {
    ...
    yield* this._walk_quadgrid_events(me);
    yield* this._walk_borders_events(me);
  ...
  //-----------------------------------------------------------------------------------------------------------
  //.........................................................................................................
  this._walk_quadgrid_events = function*(me) {
    /* TAINT don't use EXCJSCC directly */
    var col_letter_1, col_letter_2, col_nr_1, col_nr_2, quad, ref1, ref2, row_nr_1, row_nr_2, z;
    if (!me.quadgrid) {
      return null;
  ...
  //-----------------------------------------------------------------------------------------------------------
  //.........................................................................................................
  this._walk_borders_events = function*(me) {
