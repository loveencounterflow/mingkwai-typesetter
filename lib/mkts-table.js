...
(function() {
  ...
  this._walk_pod_events = function*(me, fieldhints_and_content_events) {
    var content, d, field_designation, halign_tex, i, len, ref1, ref2, ref3, ref4, ref5, sub_event, valign_tex, z;
    ...
    for (z of ref1) {
      ...
      halign_tex = this._get_halign_tex(me, (ref4 = (ref5 = me.haligns[field_designation]) != null ? ref5 : me.haligns['*']) != null ? ref4 : 'left');
