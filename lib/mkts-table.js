...
(function() {
  'use strict';
  var $, $async, CND, D, ECS, EXCJSCC, IG, MD_READER, MKTS, _fail, _record, _record_fail, _stackerr, alert, badge, copy, debug, echo, help, hide, info, is_hidden, is_stamped, jr, log, rpr, select, stamp, tex, texr, unstamp, urge, warn, whisper,
    indexOf = [].indexOf;
  ...
  this._new_description = function(S) {
    ...
    R = {
      ...
      /* [ 0 ] is default, [ 1 .. grid.width ] explicit or implicit widths */cellheights: [null],
  ...
  //-----------------------------------------------------------------------------------------------------------
  this._set_cellsizes = function(me, direction, text) {
    var i, lane_count, match, nr, p, ref1, value;
    if (direction !== 'width' && direction !== 'height') {
  ...
  this.cellwidths = function(me, text) {
    return this._set_cellsizes(me, 'width', text);
  };

  this.cellheights = function(me, text) {
    return this._set_cellsizes(me, 'height', text);
  };
  ...
  this.fieldborder = function(me, text) {
    var base, d, field, i, j, len, len1, ref1, ref2, side;
  ...
  this.fieldalignvertical = function(me, text) {
    ...
    ref1 = this._walk_f_field_designations_from_hints(me, fieldhints);
    //.........................................................................................................
    for (z of ref1) {
  ...
  this._walk_debug_cellgrid_events = function*(me) {
    ...
    bottom = (this._bottom_from_row_nr(me, me.grid.height)) + 3;
    for (col_nr = i = 1, ref1 = me.grid.width + 1; (1 <= ref1 ? i <= ref1 : i >= ref1); col_nr = 1 <= ref1 ? ++i : --i) {
    ...
    right = (this._right_from_col_nr(me, me.grid.width)) + 3;
    for (row_nr = j = 1, ref2 = me.grid.height + 1; (1 <= ref2 ? j <= ref2 : j >= ref2); row_nr = 1 <= ref2 ? ++j : --j) {
  ...
  this._ensure_cellwidths = function(me) {
    if ((me.cellwidths.length === me.grid.width + 1) && (indexOf.call(me.cellwidths.slice(1), null) < 0)) {
      return null;
    }
  ...
  this._ensure_cellheights = function(me) {
    if ((me.cellheights.length === me.grid.height + 1) && (indexOf.call(me.cellheights.slice(1), null) < 0)) {
      return null;
    }
  ...
  this._walk_column_letters_and_numbers = function*(me, mode) {
    ...
    for (col_nr = i = 1, ref1 = me.grid.width + delta; (1 <= ref1 ? i <= ref1 : i >= ref1); col_nr = 1 <= ref1 ? ++i : --i) {
  ...
  this._walk_row_numbers = function*(me, mode) {
    ...
    this._ensure_grid(me);
    delta = mode === 'short' ? 0 : 1;
    for (row_nr = i = 1, ref1 = me.grid.height + delta; (1 <= ref1 ? i <= ref1 : i >= ref1); row_nr = 1 <= ref1 ? ++i : --i) {
      yield row_nr;
    }
  };
  ...
  //-----------------------------------------------------------------------------------------------------------
  this._walk_f_field_designations_from_hints = function*(me, fieldhints) {
    /* TAINT this will have to be changed to allow for named fields */
