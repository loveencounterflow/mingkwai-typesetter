(function() {
  ...
  this.$process_actions = (function(_this) {
    return function(S) {
      ...
      var CS, VM, copy, hide, local_filename, macro_output, sandbox, sandbox_backup, stamp;
      ...
      S.sandbox = {
        ...
        snapshot: function() {
          debug('131-1 sandbox       ', sandbox != null ? sandbox['COLUMNS'] : void 0);
          debug('131-2 sandbox_backup', sandbox_backup != null ? sandbox_backup['COLUMNS'] : void 0);
          sandbox_backup = MKTS.DIFFPATCH.snapshot(sandbox);
          debug('131-3 sandbox       ', sandbox != null ? sandbox['COLUMNS'] : void 0);
          debug('131-4 sandbox_backup', sandbox_backup != null ? sandbox_backup['COLUMNS'] : void 0);
          return null;
        },
        get_context: function() {
          return sandbox;
        },
        new_change_event: function() {
          var changeset;
          debug('131-5 sandbox       ', sandbox != null ? sandbox['COLUMNS'] : void 0);
          debug('131-6 sandbox_backup', sandbox_backup != null ? sandbox_backup['COLUMNS'] : void 0);
      ...
      return $(function(event, send) {
        var _, action_value, action_value_rpr, change_event, changeset, error, error1, error2, error_message, js_source, language, line_nr, macro_output_rpr, meta, mode, raw_source, ref, ref1, wrapped_source;
        if (MKTS.MD_READER.select('(', 'document')) {
          ...
          return send(stamp(['~', 'change', changeset, copy(meta)]));
  ...
  this._parameters_from_text = (function(_this) {
    return function(S, line_nr, text) {
      ...
      if (error_message == null) {
        try {
          R = VM.runInContext(js_source, S.sandbox.get_context(), {
            filename: 'parameter resolution'
          });
        } catch (error2) {
          error = error2;
