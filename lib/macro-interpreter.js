(function() {
  ...
  this.$prepare_sandbox = (function(_this) {
    return function(S) {
  ...
  this.$process_actions = (function(_this) {
    return function(S) {
      ...
      var CS, VM, copy, hide, local_filename, macro_output, sandbox, select, stamp;
      copy = MKTS.MD_READER.copy.bind(MKTS.MD_READER);
      stamp = MKTS.MD_READER.stamp.bind(MKTS.MD_READER);
      hide = MKTS.MD_READER.hide.bind(MKTS.MD_READER);
      select = MKTS.MD_READER.select.bind(MKTS.MD_READER);
      ...
      sandbox = {};
      return $(function(event, send) {
        var _, action_value, action_value_rpr, changeset, error, error1, error2, error_message, js_source, language, line_nr, macro_output_rpr, meta, mode, raw_source, ref, ref1, sandbox_backup, wrapped_source;
