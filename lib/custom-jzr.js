(function() {
  ...
  this.$main = (function(_this) {
    return function(S) {
      ...
      return D.TEE.from_pipeline([_this.$fontlist(S), _this.$most_frequent.with_fncrs.$rewrite_events(S), _this.$most_frequent.$read(S), _this.$most_frequent.with_fncrs.$read(S), _this.$most_frequent.with_fncrs.$format(S), _this.$most_frequent.with_fncrs.$assemble(S), _this.$most_frequent.$assemble(S)]);
    };
  })(this);
