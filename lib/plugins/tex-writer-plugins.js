...
(function() {
  //###########################################################################################################
  var CND, FS, MD_READER, OVAL, PATH, PIPEDREAMS, PS, alert, badge, copy, debug, echo, finished_sym, help, hide, info, is_hidden, is_stamped, jr, log, new_pushable, new_sync_sub_sender, promisify, rpr, select, stamp, unstamp, urge, warn, whisper;
  ...
  //-----------------------------------------------------------------------------------------------------------
  new_sync_sub_sender = function(transforms, callback) {
    var collector, i, len, pipeline, pushable, transform;
  ...
  this.$plugins = (S) => {
    ...
    return PIPEDREAMS.$async((event, send, end) => {
      var Q, callback, has_finished, meta, name, plugin, send_to_plugins, type;
      if (end != null) {
        return end();
      }
      ...
      //.......................................................................................................
        ...
        callback = function(events) {
          var i, len;
          if (has_finished) {
            throw new Error(`called with ${rpr(events)} arrived when callback had finished`);
          }
