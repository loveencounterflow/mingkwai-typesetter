...
//.........................................................................................................
  ...
  this["integer multiples"] = function(T, done) {
    var cmp_probe, cmp_probe_txt, error, i, len, matcher, probes, probes_and_matchers, ref_probe, ref_probe_txt, result;
    probes_and_matchers = [[["5mm", "15mm"], "2mm"]];
//.........................................................................................................
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      [probes, matcher] = probes_and_matchers[i];
      [ref_probe_txt, cmp_probe_txt] = probes;
      ref_probe = UNITS.parse_nonnegative_quantity(ref_probe_txt);
      cmp_probe = UNITS.parse_nonnegative_quantity(cmp_probe_txt);
      try {
        result = UNITS.integer_multiple(ref_probe, cmp_probe);
      } catch (error1) {
        error = error1;
