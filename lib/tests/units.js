...
//.........................................................................................................
  ...
  //-----------------------------------------------------------------------------------------------------------
  this["addition"] = function(T, done) {
    var error, i, len, matcher, probe_a, probe_a_copy, probe_b, probe_b_copy, probes_and_matchers, result;
    probes_and_matchers = [
      [
        ["15mm",
        "5mm"],
...
//.........................................................................................................
    for (i = 0, len = probes_and_matchers.length; i < len; i++) {
      [[probe_a, probe_b], matcher] = probes_and_matchers[i];
  ...
  if (module.parent == null) {
    include = ["UNITS.parse 1", "UNITS.as_text 1", "UNITS.as_text 2", "UNITS.as_text 3", "integer multiples"];
    this._prune();
    this._main();
  }
