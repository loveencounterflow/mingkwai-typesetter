...
(function() {
  //###########################################################################################################
  var CND, EXCJSCC, XREGEXP, alert, badge, cellquad, d, debug, demo_tableparsing, echo, help, info, jr, log, njs_fs, njs_path, ref, remark_grid_tables, remark_parse, remark_to_html, remark_to_rehype, rpr, show_permutations, stringify, unified, urge, warn, whisper;
  ...
  //-----------------------------------------------------------------------------------------------------------
  // @_walk_cell_sides = ( me, cellquad, side ) ->
  //   switch side
  //     when 'left'
  //       row_nr_1    = cellquad.top
  //       row_nr_2    = cellquad.bottom
