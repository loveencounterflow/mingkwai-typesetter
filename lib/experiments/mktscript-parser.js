...
(function() {
  ...
  if (module.parent == null) {
    S = {};
    texts = ['a line of text.', 'a line of *text*.', 'a line of 𣥒text*.', 'a **strong** and a *less strong* emphasis.', 'a *normal and a **strong** emphasis*.', 'another *such and **such*** emphasis.'];
