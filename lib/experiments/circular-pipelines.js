...
(function() {
  'use strict';
  var $, $async, $recycle, $unwrap_recycled, CND, COLLATZ, FS, PATH, PS, S, alert, assign, badge, copy, debug, echo, help, i, info, is_recycling, is_stamped, is_system, jr, log, n, new_end_event, new_event, new_push_source, new_single_event, new_start_event, new_stop_event, new_system_event, provide_collatz, recycling, rpr, rprx, select, select_all, send, stamp, unwrap_recycled, urge, warn, whisper, xxx,
