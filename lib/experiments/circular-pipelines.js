...
(function() {
  'use strict';
  var $, $async, $recycle, $unwrap_recycled, CND, COLLATZ, FS, PATH, PS, S, alert, assign, badge, copy, debug, echo, help, i, info, is_recycling, is_stamped, is_system, jr, log, n, new_end_event, new_event, new_pushable, new_single_event, new_system_event, provide_collatz, recycling, rpr, rprx, select, select_all, send, stamp, unwrap_recycled, urge, warn, whisper,
  ...
  // debug ( name for name of require './recycle' ).sort()
  }).js;

  ({$recycle, $unwrap_recycled, is_recycling, is_stamped, is_system, new_end_event, new_event, recycling, new_single_event, new_system_event, select, select_all, stamp, unwrap_recycled} = require('./recycle'));
