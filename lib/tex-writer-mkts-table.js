...
(function() {
  ...
  this.$handle_content_events = function(S, L) {
    return $((event, send) => {
      var Q, _, content_events, enclosed_content_events, enclosing_content_events, enclosing_layout_name, layout, layout_name, selectors_and_content_events, sub_event;
      //.......................................................................................................
      ...
      description-end and description events: */
        ...
        if (enclosing_layout_name != null) {
          if (L.current_field_selector == null) {
  ...
  this.$handle_fields = function(S, L) {
    ...
    return $((event, send) => {
      ...
      if (select(event, '(', 'field')) {
        ...
        content_buffer = this.new_content_buffer(S, L, layout_name, L.current_field_selector);
