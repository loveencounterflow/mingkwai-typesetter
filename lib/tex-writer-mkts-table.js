...
(function() {
  ...
  this.$main = function(S) {
    //.........................................................................................................
    return D.TEE.from_pipeline([this.$parse_description(S), this.$collect_field_contents(S), this.$dump_table_description(S)]);
  };
  ...
  this.$collect_field_contents = function(S) {
    ...
    var current_field, fieldhints_and_content_events, prv_description, within_field, within_table_content;
    ...
    return $((event, send) => {
      ...
      if (select(event, ')', 'mkts-table-content')) {
        within_table_content = false;
        ref = MKTS_TABLE._walk_events(prv_description, fieldhints_and_content_events);
      ...
      if (within_table_content) {
        ...
        if (within_field) {
          ...
          urge('27762', jr(event)); // send stamp event
          return;
        }
        //.....................................................................................................
  ...
  this.get_mkts_table_description_and_sandbox = function(S, event) {
    ...
    f = function() {
      ...
      this.cellwidths = function(raw_parts) {
        return MKTS_TABLE.cellwidths(me, raw_parts.join(''));
      };
      this.cellheights = function(raw_parts) {
        return MKTS_TABLE.cellheights(me, raw_parts.join(''));
      };
