...
(function() {
  'use strict';
  var $, $async, CND, D, MD_READER, MKTS, MKTS_TABLE, alert, badge, copy, debug, echo, help, hide, info, is_hidden, is_stamped, jr, log, new_local_state, rpr, select, stamp, unstamp, urge, warn, whisper;
