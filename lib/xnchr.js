(function() {
  var CND, alert, badge, debug, echo, help, info, log, rpr, settings, warn, whisper;
  ...
  this.CHR = require('coffeenode-chr');
  ...
  this.analyze = function(glyph) {
    return this.CHR.analyze(glyph, settings);
  };

  this.as_csg = function(glyph) {
    return this.CHR.as_csg(glyph, settings);
  };

  this.as_chr = function(glyph) {
    return this.CHR.as_chr(glyph, settings);
  };

  this.as_uchr = function(glyph) {
    return this.CHR.as_uchr(glyph, settings);
  };

  this.as_cid = function(glyph) {
    return this.CHR.as_cid(glyph, settings);
  };

  this.as_rsg = function(glyph) {
    return this.CHR.as_rsg(glyph, settings);
  };

  this.as_sfncr = function(glyph) {
    return this.CHR.as_sfncr(glyph, settings);
  };

  this.as_fncr = function(glyph) {
    return this.CHR.as_fncr(glyph, settings);
  };

  this.chrs_from_text = function(text) {
    return this.CHR.chrs_from_text(text, settings);
  };
  ...
  this.chr_from_cid_and_csg = function(cid, csg) {
    return this.CHR.as_chr(cid, {
      csg: csg
    });
  };

  this.cid_range_from_rsg = function(rsg) {
    return this.CHR.cid_range_from_rsg(rsg);
  };
