(function() {
    ...
    f = (function(_this) {
      return function() {
        return step(function*(resume) {
          var S, content_locator, file_output, layout_info, md_input, md_output, md_source, md_tee, mkscript_locator, mkscript_output, source_locator, tex_input, tex_output, tex_tee;
          if (handler == null) {
            handler = function() {};
          }
          ...
          tex_tee = _this.create_tex_write_tee(S);
  ...
  this.tex_from_md = function(md_source, settings, handler) {
    ...
    /* TAINT code duplication */
    var $collect_and_call, S, arity, layout_info, md_input, md_output, md_tee, ref1, source_route, tex_input, tex_output, tex_tee;
    ...
    md_tee = MKTS.create_md_read_tee(md_source);
    tex_tee = this.create_tex_write_tee(S);
    md_input = md_tee['input'];
    md_output = md_tee['output'];
    tex_input = tex_tee['input'];
    tex_output = tex_tee['output'];
