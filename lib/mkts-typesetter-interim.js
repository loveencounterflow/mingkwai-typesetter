(function() {
  ...
  this.create_tex_writefitting = function(layout_info, input) {
    ...
    var R, S, mktscript_in, mktscript_out, readstream, settings, writestream;
    S = {
    ...
    f = (function(_this) {
      return function() {
        return step(function*(resume) {
          var content_locator, input, layout_info, mkscript_locator, mkscript_output, source_locator, tex_fitting, tex_output, tex_stream, text;
          if (handler == null) {
            handler = function() {};
          }
          ...
          tex_stream.pipe(tex_output);
          tex_fitting['outputs']['mktscript'].pipe(mkscript_output);
          return input.resume();
        });
      };
    })(this);
  ...
  this.mktscript_from_md = function(text, settings, handler) {

    /* TAINT code duplication */
    var Z, arity, f, input, layout_info, mktscript_stream, ref1, source_route, tex_fitting;
    switch (arity = arguments.length) {
      case 2:
        handler = settings;
        settings = {};
    ...
    Z = [];
    mktscript_stream.pipe($((function(_this) {
      return function(event, send) {
        return Z.push(event);
      };
    })(this)));
