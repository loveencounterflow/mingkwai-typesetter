(function() {
  ...
  this.create_tex_writefitting = function(layout_info) {
    ...
    var S, readstream, settings, writestream;
    S = {
  ...
  this.tex_from_md = function(md_source, settings, handler) {
    ...
    var arity, layout_info, md_fitting, md_input, md_output, ref1, source_route, tex_fitting, tex_input, tex_output;
    ...
    D.$collect_and_call = (function(_this) {
    ...
    tex_fitting = this.create_tex_writefitting(layout_info);
    ...
    tex_output.pipe(D.$collect_and_call(handler));
