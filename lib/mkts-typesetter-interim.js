(function() {
  ...
  this.create_tex_writefitting = function(S) {
    ...
    f = (function(_this) {
      return function() {
        return step(function*(resume) {
          var S, content_locator, file_output, layout_info, md_fitting, md_input, md_output, md_source, mkscript_locator, mkscript_output, source_locator, tex_fitting, tex_input, tex_output;
          if (handler == null) {
            handler = function() {};
          }
          ...
          tex_fitting = _this.create_tex_writefitting(S);
          ...
          tex_output.pipe($(function(event, send, end) {
            if (event != null) {
  ...
  this.tex_from_md = function(md_source, settings, handler) {
    ...
    /* TAINT code duplication */
    var $collect_and_call, S, arity, layout_info, md_fitting, md_input, md_output, ref1, source_route, tex_fitting, tex_input, tex_output;
    ...
    md_fitting = MKTS.create_md_readfitting(md_source);
    tex_fitting = this.create_tex_writefitting(S);
    md_input = md_fitting['input'];
    md_output = md_fitting['output'];
    tex_input = tex_fitting['input'];
    tex_output = tex_fitting['output'];
