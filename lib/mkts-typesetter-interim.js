(function() {
  ...
  this.create_texwritestream = function(layout_info, input) {
    ...
    f = (function(_this) {
      return function() {
        return step(function*(resume) {
          var content_locator, input, layout_info, source_locator, tex_output, tex_stream, text;
          if (handler == null) {
            handler = function() {};
          }
          ...
          tex_stream = _this.create_texwritestream(layout_info, input);
  ...
  this.tex_from_md = function(text, settings, handler) {
    var Z, arity, f, input, layout_info, ref1, source_route, tex_stream;
    ...
    tex_stream = this.create_texwritestream(layout_info, input);
    Z = [];
