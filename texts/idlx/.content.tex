...
\vspace{\myLineheight}\begin{multicols}{2}\raggedcolumns{}{\mktsStyleItalic{}Remarks\/}:
...
\vspace{\myLineheight}\begin{multicols}{2}\raggedcolumns{}{\mktsStyleBold{}a-3}: The L-shape, \cjkgGlue{\cjk{}\cjkgGlue{\cnjzr{}}\cjkgGlue{}}\cjkgGlue{}, is the only binary relationship that occurs in both of
...
\url{https://raw.githubusercontent.com/cjkvi/cjkvi-ids/master/ids.txt} for actual examples}All other elements (i.e. except for \cjkgGlue{\cjk{}廴}\cjkgGlue{} and \cjkgGlue{\cjk{}辶}\cjkgGlue{}) that enclose another one from the left and
